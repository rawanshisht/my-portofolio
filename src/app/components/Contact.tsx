...
export default function Contact() {
    return (
        <section id="contact" className="min-h-screen scroll-mt-20 flex flex-col justify-center items-center">
            <h2 className="text-4xl md:text-5xl font-bold text-sky-200 uppercase text-center"> Let&apos;s Build Something Amazing</h2>
            <h3 className="text-xl md:text-2xl/10 text-center font-semibold p-6 text-sky-100 tracking-none md:tracking-wider w-5/6 mx-auto">
                Looking for a developer who can create high-performance, interactive web experiences?
            </h3>
            <h3 className="text-xl md:text-2xl/10 text-center font-semibold text-sky-100 tracking-none md:tracking-wider mx-auto">
            ...
            <div className="flex gap-6 text-sky-100 my-6">
                <a className="text-lg text-sky-100 "
